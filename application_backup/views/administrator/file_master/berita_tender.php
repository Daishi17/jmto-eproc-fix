    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card border-dark">
                <div class="card-header border-dark bg-gradient-yellow d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1 bd-highlight">
                        <span class="text-dark">
                            <i class="fa-regular fa-folder-open px-1"></i>
                            <small><strong>Data Tabel - Informasi Berita</strong></small>
                        </span>
                    </div>
                ...
                <div class="card-body">
                    <table id="tbl_berita_tender" class="table table-bordered table-sm table-striped">
                        <thead class="bg-secondary">
                            <tr>
                                ...
                                <th style="width:10%;"><small class="text-white">Pembuat Berita</small></th>
