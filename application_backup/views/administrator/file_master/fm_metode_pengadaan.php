    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card border-dark">
                <div class="card-header border-dark bg-warning d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1 bd-highlight">
                        <span class="text-dark">
                            ...
                            <small><strong>Data Tabel - Metode Pengadaan</strong></small>
                        </span>
                    </div>
                ...
                <!-- url -->
                <input type="hidden" name="url_post" value="<?= base_url('administrator/fm_metode_pengadaan/save') ?>">
                <input type="hidden" name="url_get_metode_pengadaan" value="<?= base_url('administrator/fm_metode_pengadaan/datatable_metode_pengadaan') ?>">
                <input type="hidden" name="url_get_byid" value="<?= base_url('administrator/fm_metode_pengadaan/byid/') ?>">
                <input type="hidden" name="url_aktifkan_metode_pengadaan" value="<?= base_url('administrator/fm_metode_pengadaan/aktif/') ?>">
                <input type="hidden" name="url_nonaktifkan_metode_pengadaan" value="<?= base_url('administrator/fm_metode_pengadaan/nonaktif/') ?>">
                <!-- end url -->
                <div class="card-body">
                    <table id="tbl_metode_pengadaan" class="table table-bordered table-sm table-striped">
                        <thead class="bg-secondary">
                            <tr>
                                <th style="width:10%;"><small class="text-white">Kode</small></th>
                                <th style="width:60%;"><small class="text-white">Metode Pengadaan</small></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small>Seleksi Umum</small></td>
                                <td><small><span class="badge bg-success">Aktif</span></small></td>
                                <td>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-info btn-sm shadow-lg" data-bs-toggle="modal" data-bs-target="#modal-xl-tambah">
                            ...
                            <tr>
                                ...
                                <td><small>Penunjukan Langsung</small></td>
                                <td><small><span class="badge bg-success">Aktif</span></small></td>
                                <td>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-info btn-sm shadow-lg" data-bs-toggle="modal" data-bs-target="#modal-xl-tambah">
                            ...
                            <tr>
                                ...
                                <td><small>Seleksi Terbatas</small></td>
                                <td><small><span class="badge bg-success">Aktif</span></small></td>
                                <td>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-info btn-sm shadow-lg" data-bs-toggle="modal" data-bs-target="#modal-xl-tambah">
                            ...
                            <tr>
                                ...
                                <td><small>Pengadaan Langsung</small></td>
                                <td><small><span class="badge bg-success">Aktif</span></small></td>
                                <td>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-info btn-sm shadow-lg" data-bs-toggle="modal" data-bs-target="#modal-xl-tambah">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card border-dark shadow-lg">
                                <div class="card-header border-dark bd-blue-700 d-flex justify-content-between align-items-center">
                                    <div class="flex-grow-1 bd-highlight">
                                        <span class="text-white">
                                            ...
                                            <small><strong>Form Data - Metode Pengadaan</strong></small>
                                        </span>
                                    </div>
                                    <!-- <div class="bd-highlight">
                                ...
                                <div class="card-body">
                                    <form action="javascript:;" id="form_metode_pengadaan">
                                        <div class="row g-1">
                                            <div class="col-sm-3">
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text"><i class="fa-solid fa-barcode"></i></span>
                                                    <input type="text" class="form-control" placeholder="Auto Number" value="<?= $kode_mtd_pengadaan ?>" name="kode_metode_pengadaan">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nama Metode Pengadaan" name="nama_metode_pengadaan">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card border-dark shadow-lg">
                                ...
                                <div class="card-body">
                                    <form action="javascript:;" id="form_metode_pengadaan_edit">
                                        <input type="hidden" name="id_metode_pengadaan">
                                        <div class="row g-1">
                                            <div class="col-sm-3">
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text"><i class="fa-solid fa-barcode"></i></span>
                                                    <input type="text" class="form-control" placeholder="Auto Number" readyonly name="kode_metode_pengadaan">
