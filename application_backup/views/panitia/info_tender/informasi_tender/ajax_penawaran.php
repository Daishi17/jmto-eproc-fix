<script>
    $(document).ready(function() {
        ...
        $('#table_vendor_mengikuti_paket').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": '<?= base_url('panitia/info_tender/informasi_tender/get_vendor_mengikuti_paket_penawaran') ?>',
                "type": "POST",
                data: {
                    id_rup: id_rup
                }
    ...
    $(document).ready(function() {
        ...
        $('#table_vendor_mengikuti_paket_penawaran_II').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": '<?= base_url('panitia/info_tender/informasi_tender/get_vendor_mengikuti_paket_penawaran_file_II') ?>',
                "type": "POST",
                data: {
                    id_rup: id_rup
                }
                ...
                if (type == 'lihat_dokumen_penawaran_1') {
                    ...
                    $(document).ready(function() {
                        $('#table_dokumen_penawaran_file_I_vendor').DataTable({
                            ...
                            "order": [],
                            "ajax": {
                                "url": '<?= base_url('panitia/info_tender/informasi_tender/get_dokumen_penawaran_file_I_vendor') ?>',
                                "type": "POST",
                                data: {
