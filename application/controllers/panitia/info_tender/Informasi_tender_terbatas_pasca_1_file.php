...
error_reporting(0);
class Informasi_tender_terbatas_pasca_1_file extends CI_Controller
{
    ...
    public function informasi_pengadaan($id_url_rup)
    {
        ...
        // pasca
        $data['evaluasi_kualifikasi'] =  $this->M_jadwal->jadwal_tender_terbatas_pasca_1_file_7($data['row_rup']['id_rup']);
        // end get tahap
    ...
    public function evaluasi($id_url_rup)
    {
        ...
        $data['root_jadwal'] = $data['row_rup']['root_jadwal'];
        $data['jadwal_evaluasi_dokumen_kualifikasi'] =  $this->M_jadwal->jadwal_pra_umum_6($data['row_rup']['id_rup']);
        $data['jadwal_presentasi_evaluasi'] =  $this->M_jadwal->jadwal_tender_terbatas_pasca_1_file_5($data['row_rup']['id_rup']);
    ...
    public function get_evaluasi_kualifikasi($id_rup)
    {
        ...
        $jadwal_evaluasi_dokumen_kualifikasi =  $this->M_jadwal->jadwal_tender_terbatas_pasca_1_file_4($id_rup);
    ...
    public function buka_penawaran($id_url_rup)
    {
        ...
        $this->load->view('template_tender/footer');
        $this->load->view('panitia/info_tender/' . $root_jadwal . '/ajax_penawaran', $data);
    }
    ...
    {
        $id_rup = $this->input->post('id_rup');
        $data['row_rup'] = $this->M_rup->get_row_rup_by_id_rup($id_rup);
        if ($data['row_rup']['bobot_nilai'] == 1) {
            // ini teknis
            $result_vendor_negosiasi = $this->M_panitia->get_result_vendor_negosiasi_rank1_pringkat_teknis($id_rup);
        } else if (($data['row_rup']['bobot_nilai'] == 2)) {
            // ini biaya
            $result_vendor_negosiasi = $this->M_panitia->get_result_vendor_negosiasi_rank1_pringkat_biaya($id_rup);
        } else {
            $result_vendor_negosiasi = $this->M_panitia->get_result_vendor_negosiasi_rank1_pringkat_teknis($id_rup);
        }
        $output = [
