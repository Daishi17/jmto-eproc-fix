...
<script>
    $(document).ready(function() {
        $('#tbl_rekap_vendor').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": '<?= base_url('administrator/penilaian_kinerja/get_rekap_vendor') ?>',
                "type": "POST",
            },
            "columnDefs": [{
                "target": [-1],
    ...
    function detail_paket(id_vendor) {
        $('#modal-xl-tambah').modal('show');

        $('#tbl_paket_vendor').DataTable({
            "responsive": false,
            "ordering": true,
            "processing": true,
            "serverSide": true,
            ...
            "order": [],
            "ajax": {
                "url": '<?= base_url('administrator/penilaian_kinerja/get_paket_vendor/') ?>' + id_vendor,
                "type": "POST",
            },
            "columnDefs": [{
                "target": [-1],
