                                            ...
                                            <?php if ($row_rup['status_paket_diumumkan'] == 1) { ?>
                                                ...
                                                <td>
                                                    <?php if ($value2['waktu_mulai'] == '' && $value2['waktu_selesai'] == '') { ?>
                                                        <?php if ($i == 1) { ?>
                                                            <a href="javascript:;" title="Tambah Waktu +1 Hari" onclick="plus_jadwal_21_baris(<?= $value2['id_jadwal_rup'] ?>)" class="btn btn-sm btn-primary">+</a>
                                                        <?php  } else { ?>
                                                        <?php } ?>
                                                    <?php } else { ?>
                                                        <?php if ($i == 1) { ?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <?php  } else { ?>
                                                            <a href="javascript:;" title="Tambah Waktu +1 Hari" onclick="plus_jadwal_21_baris(<?= $value2['id_jadwal_rup'] ?>)" class="btn btn-sm btn-primary">+</a>
                                                            <a href="javascript:;" title="Kurang Waktu -1 Hari" onclick="min_jadwal_21_baris(<?= $value2['id_jadwal_rup'] ?>)" class="btn btn-sm btn-primary">-</a>
                                                        <?php } ?>
                                                    <?php   } ?>
                                                </td>
                                            <?php } ?>
