<main class="container-fluid">
    ...
    <input type="hidden" name="id_manajemen_user" value="<?= $this->session->userdata('id_manajemen_user') ?>">
    <input type="hidden" name="status_paket_diumumkan" value="<?= $row_rup['status_paket_diumumkan']  ?>">
            ...
            <div class="card border-dark">
                                ...
                                <table class="table table-bordered table-sm shadow-lg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small><?= date('M Y', strtotime($row_rup['jangka_waktu_mulai_pelaksanaan'])) ?></small> - <small><?= date('M Y', strtotime($row_rup['jangka_waktu_selesai_pelaksanaan'])) ?></small>&nbsp;
                                                ...
                                                <?php if ($row_rup['status_paket_diumumkan'] == 1) { ?>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <?php if (!$row_rup['jenis_kontrak']) { ?>
                                                            ...
                                                            <option value="6">Kontrak Payung</option>
                                                        ...
                                                        <?php } else if ($row_rup['jenis_kontrak'] == 5) { ?>
                                                            ...
                                                            <option value="6">Kontrak Payung</option>
                                                        <?php } else if ($row_rup['jenis_kontrak'] == 6) { ?>
                                                            <option value="1">Lump Sum</option>
                                                            <option value="2">Harga Satuan</option>
                                                            <option value="3">Gabungan Lump Sum dan Harga Satuan</option>
                                                            <option value="4">Terima Jadi (Turnkey)</option>
                                                            <option value="5">Persentase (%)</option>
                                                            <option value="6" selected>Kontrak Payung</option>
                                                        <?php } ?>
                                        ...
                                        <td colspan="2">
                                            <div class="input-group mb-2">
                                                ...
                                                <?php  } else { ?>
                                                    ...
                                                    <?php } else if ($row_rup['bobot_nilai'] == 2) { ?>
                                                        <span class="input-group-text"><i class="fa-solid fa-money-bill"></i>&ensp;Bobot Teknis</span>
                                                        <input type="number" class="form-control bg-info" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;" placeholder="Bobot Teknis" name="bobot_teknis" onkeyup="bobot_teknis()" onkeyup="bobot_biaya()" value="<?= $row_rup['bobot_teknis'] ?>" readonly>
                                                        <span class="input-group-text"><i class="fa-solid fa-percent"></i></span>

                                                        <span class="input-group-text"><i class="fa-solid fa-money-bill"></i>&ensp;Bobot Biaya</span>
                                                        <input type="number" class="form-control bg-info" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;" placeholder="Bobot Biaya" name="bobot_biaya" onkeyup="bobot_biaya()" readonly value="<?= $row_rup['bobot_biaya'] ?>">
                                                        <span class="input-group-text"><i class="fa-solid fa-percent"></i></span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-default" colspan="3">
                                            ...
                                            <?php } else if ($row_rup['id_jadwal_tender'] == 9 || $row_rup['id_jadwal_tender'] == 10) { ?>
                                                <button type="button" class="btn btn-sm btn-warning text-white" onclick="get_terekomendasi()">
                                                    <i class="fa-solid fa-building-user px-1"></i>
                                                    Pilih Penyedia
                                                </button>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <div class="input-group-text">
                                                                        <?php if ($row_rup['sts_pakta_integritas'] == 1) { ?>
                                                                            <input id="cek_fakta_integritas" class="form-check-input mt-0" type="checkbox" checked disabled>
                                                                        <?php } else { ?>
                                                                            <input id="cek_fakta_integritas" class="form-check-input mt-0" type="checkbox" disabled>
                                                                        <?php   } ?>
                ...
                <div class="card-footer bg-transparent border-dark">
                    <form action="javascript:;" id="form_simpan_paket">
                        ...
                        <?php  }  ?>
                        <a class="btn btn-default btn-warning" href="<?= base_url('panitia/daftar_paket/daftar_paket') ?>">
                                ...
                                <div class="card border-dark shadow-lg">
                                    <div class="card-header border-dark bd-blue-700 d-flex justify-content-between align-items-center">
                                        <div class="flex-grow-1 bd-highlight">
                                            <span class="text-white">
                                                <i class="fa-regular fa-rectangle-list px-1"></i>
                                                <small><strong>Form Data - Persyaratan Kualifikasi Pengadaan </strong></small>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <?php if ($row_rup['status_paket_diumumkan'] == 1) { ?>
                                                <tbody>
                                                    ...
                                                    foreach ($result_vendor_terundang as $key => $value) { ?>
                                                        <tr>
                                                            <td class="col-sm-1"><small><?= $i++ ?></small></td>
                                                            <td class="col-sm-4"><small><?= $value ?></small></td>
                                                            <td class="col-sm-2"><small><?= $this->M_panitia->get_info_vendor($value, 'email'); ?></small></td>
                                                            <td class="col-sm-2"><small><?= $this->M_panitia->get_info_vendor($value, 'kualifikasi_usaha'); ?></small></td>
                                                            <td class="col-sm-2"><small><?= $this->M_panitia->get_info_vendor($value, 'nilai_vendor'); ?></small></td>
                                                            <!-- <td class="col-sm-2"><small>Aksi</small></td> -->
                                                        </tr>
                                                    <?php   } ?>
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <?php if ($row_rup['id_jadwal_tender'] == 2 || $row_rup['id_jadwal_tender'] == 1 || $row_rup['id_jadwal_tender'] == 3) { ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div style="text-align:justify">
                            ...
                            <ol>
                                <li>Kami telah melaksanakan proses pengadaan di PT Jasamarga Tollroad Operator, sesuai dengan kewenangan yang diberikan oleh anggaran dasar dan peraturan perusahaan serta peraturan perundang-undangan, berdasarkan prinsip-prinsip itikad baik, dengan kecermatan yang tinggi, dan dalam keadaan bebas, mandiri atau tidak dibawah tekanan, maupun pengaruh dari pihak lain (independency)</li>
                ...
                <div class="modal-footer">
                    ...
                    <?php } else { ?>
                        <button type="button" onclick="setujui_pakta_integritas()" class="btn btn-primary">Setuju</button>
                    <?php   } ?>
