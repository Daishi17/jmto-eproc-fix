<input type="hidden" name="url_upload_sanggahan_pra" value="<?= base_url('panitia/info_tender/informasi_tender/upload_sanggahan_pra/') ?>">
<input type="hidden" name="url_hapus_sanggahan_pra" value="<?= base_url('panitia/info_tender/informasi_tender/hapus_sanggahan_pra/') ?>">
<input type="hidden" name="url_get_sanggahan_pra" value="<?= base_url('panitia/info_tender/informasi_tender/get_sanggahan_pra') ?>">
            ...
            <div class="card border-dark">
                <div class="card-header border-dark bg-white text-black">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active  " style="margin-left: 5px;" href="<?= base_url('panitia/info_tender/informasi_tender/sanggahan_prakualifikasi/' . $row_rup['id_url_rup']) ?>"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Sanggahan Prakualifikasi</a>
                        </li>
                        <li class="nav-item">
