        ...
        <form action="javascript:;" method="POST" id="form_ba_pasca1">
            ...
            <div class="container">
                <p style="text-align:justify; font-size:15px">
                    ...
                    Tahun <b> <?= terbilang(date('Y', strtotime($row_rup['ba_evaluasi_tgl']))) ?> (<?= date('d-m-Y', strtotime($row_rup['ba_evaluasi_tgl'])) ?>)</b>, pukul <?= $row_rup['ba_pembuktian_jam_pelaksanaan'] ?> Panitia Pengadaan telah mengadakan Rapat Evaluasi Prakualifikasi Peserta Tender Umum dengan hasil-hasil sebagai berikut:
                </p>
                ...
                <ol>
                    <li>
                        Jumlah Perusahaan yang mendaftar dan mengambil Dokumen Prakualifikasi sebanyak 18 (Delapan belas) Perusahaan, yaitu:
                        <ol class="mt-2">
                            <?php $i = 1;
                    ...
                    <li class="mt-3">
                        Perusahaan yang mengembalikan dan memasukan Dokumen Prakualifikasi adalah sebanyak 9 (Sembilan) Perusahaan, yaitu:
                        <ol class="mt-2">
                            <?php $i = 1;
                ...
                <p>Hasil Evaluasi Prakualifikasi Peserta Tender Umum tertuang dalam Lampiran Berita Acara ini.</p>
                <p>Demikian Berita Acara Evaluasi Prakualifikasi Peserta Tender Umum <b><?= $row_rup['nama_rup'] ?> PT Jasamarga Tollroad Operator </b> ini dibuat untuk dapat dipergunakan sebagaimana mestinya. </p>
