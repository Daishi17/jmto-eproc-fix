        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_siup" method="post">
                    <input type="hidden" name="url_encryption_siup" value="<?= base_url('validator/rekanan_terundang/encryption_siup/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_siup">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_siup" value="<?= base_url('validator/rekanan_terundang/validation_siup/') ?>">
                    <input type="hidden" name="id_url_siup">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_nib" method="post">
                    <input type="hidden" name="url_encryption_nib" value="<?= base_url('validator/rekanan_terundang/encryption_nib/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_nib">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_nib" value="<?= base_url('validator/rekanan_terundang/validation_nib/') ?>">
                    <input type="hidden" name="id_url_nib">
                    <input type="hidden" name="type" value="nonvalid">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_sbu" method="post">
                    <input type="hidden" name="url_encryption_sbu" value="<?= base_url('validator/rekanan_terundang/encryption_sbu/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_sbu">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_sbu" value="<?= base_url('validator/rekanan_terundang/validation_sbu/') ?>">
                    <input type="hidden" name="id_url_sbu">
                    <input type="hidden" name="type" value="nonvalid">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_siujk" method="post">
                    <input type="hidden" name="url_encryption_siujk" value="<?= base_url('validator/rekanan_terundang/encryption_siujk/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_siujk">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_siujk" value="<?= base_url('validator/rekanan_terundang/validation_siujk/') ?>">
                    <input type="hidden" name="id_url_siujk">
                    <input type="hidden" name="type" value="nonvalid">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_skdp" method="post">
                    <input type="hidden" name="url_encryption_skdp" value="<?= base_url('validator/rekanan_terundang/encryption_skdp/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_skdp">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_skdp" value="<?= base_url('validator/rekanan_terundang/validation_skdp/') ?>">
                    <input type="hidden" name="id_url_skdp">
                    <input type="hidden" name="type" value="nonvalid">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_akta_pendirian" method="post">
                    <input type="hidden" name="url_encryption_akta_pendirian" value="<?= base_url('validator/rekanan_terundang/encryption_akta_pendirian/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_akta_pendirian">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_akta_pendirian" value="<?= base_url('validator/rekanan_terundang/validation_akta_pendirian/') ?>">
                    <input type="hidden" name="id_url_akta_pendirian">
                    <input type="hidden" name="type" value="nonvalid">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_akta_perubahan" method="post">
                    <input type="hidden" name="url_encryption_akta_perubahan" value="<?= base_url('validator/rekanan_terundang/encryption_akta_perubahan/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_akta_perubahan">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_akta_perubahan" value="<?= base_url('validator/rekanan_terundang/validation_akta_perubahan/') ?>">
                    <input type="hidden" name="id_url_akta_perubahan">
                    <input type="hidden" name="type" value="nonvalid">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_pemilik">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_pemilik" value="<?= base_url('validator/rekanan_terundang/validation_pemilik/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_pengurus">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_pengurus" value="<?= base_url('validator/rekanan_terundang/validation_pengurus/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_pengalaman">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_pengalaman" value="<?= base_url('validator/rekanan_terundang/validation_pengalaman/') ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_sppkp" method="post">
                    <input type="hidden" name="url_encryption_sppkp" value="<?= base_url('validator/rekanan_terundang/encryption_sppkp/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_sppkp">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_sppkp" value="<?= base_url('validator/rekanan_terundang/validation_sppkp/') ?>">
                    <input type="hidden" name="id_url_sppkp">
                    <input type="hidden" name="type" value="nonvalid">
                    <input type="hidden" name="type_kbli" id="kbli_nonvalid">
                    <center>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_npwp" method="post">
                    <input type="hidden" name="url_encryption_npwp" value="<?= base_url('validator/rekanan_terundang/encryption_npwp/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_npwp">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_npwp" value="<?= base_url('validator/rekanan_terundang/validation_npwp/') ?>">
                    <input type="hidden" name="id_url_npwp">
                    <input type="hidden" name="type" value="nonvalid">
                    <input type="hidden" name="type_kbli" id="kbli_nonvalid">
                    <center>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_spt" method="post">
                    <input type="hidden" name="url_encryption_spt" value="<?= base_url('validator/rekanan_terundang/encryption_spt/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_spt">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_spt" value="<?= base_url('validator/rekanan_terundang/validation_spt/') ?>">
                    <input type="hidden" name="id_url_spt">
                    <input type="hidden" name="type" value="nonvalid">
                    <input type="hidden" name="type_kbli" id="kbli_nonvalid">
                    <center>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_neraca" method="post">
                    <input type="hidden" name="url_encryption_neraca" value="<?= base_url('validator/rekanan_terundang/encryption_neraca/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_neraca">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_neraca" value="<?= base_url('validator/rekanan_terundang/validation_neraca/') ?>">
                    <input type="hidden" name="id_url_neraca">
                    <input type="hidden" name="type" value="nonvalid">
                    <input type="hidden" name="type_kbli" id="kbli_nonvalid">
                    <center>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_dekrip_keuangan" method="post">
                    <input type="hidden" name="url_encryption_keuangan" value="<?= base_url('validator/rekanan_terundang/encryption_keuangan/') ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_nonvalid_keuangan">
                <div class="modal-body">
                    <input type="hidden" name="url_validasi_keuangan" value="<?= base_url('validator/rekanan_terundang/validation_keuangan/') ?>">
                    <input type="hidden" name="id_url_keuangan">
                    <input type="hidden" name="type" value="nonvalid">
                    <input type="hidden" name="type_kbli" id="kbli_nonvalid">
                    <center>
