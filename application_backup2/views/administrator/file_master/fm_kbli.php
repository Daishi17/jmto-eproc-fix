                ...
                <div class="card-header border-dark bg-gradient-yellow d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1 bd-highlight">
                        <span class="text-dark">
                            <i class="fa-regular fa-folder-open px-1"></i>
                            <small><strong>Data Tabel - Klasifikasi Baku Lapang Usaha Indonesia (KBLI)</strong></small>
                        </span>
                    </div>
                    <div class="bd-highlight">
                        <button type="button" class="btn btn-success btn-sm shadow-lg" data-bs-toggle="modal" data-bs-target="#modal-xl-tambah">
                    ...
                    <table id="example1" class="table table-bordered table-sm table-striped">
                        <thead class="bg-secondary">
                            <tr>
                                ...
                                <th style="width:60%;"><small class="text-white">Jenis KBLI</small></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="btn bg-gradient-yellow btn-sm shadow-lg">
                                ...
                                <div class="card-header border-dark bd-blue-700 d-flex justify-content-between align-items-center">
                                    <div class="flex-grow-1 bd-highlight">
                                        <span class="text-white">
                                            ...
                                            <small><strong>Form Data - Klasifikasi Baku Lapang Usaha Indonesia (KBLI)</strong></small>
                                        </span>
                                    </div>
                                    <div class="bd-highlight">
                                        ...
                                        <div class="row g-1">
                                            <div class="col-sm-3">
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Kode KBLI">
