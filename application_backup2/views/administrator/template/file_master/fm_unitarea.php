                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-sm table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><small>202.101</small></td>
                                <td><small>Human Capital</small></td>
                                <td><small>Human Capital & General Affair</small></td>
                                <td><small><span class="badge bg-success">Aktif</span></small></td>
                                <td>
                                    <div class="text-center">
                                        ...
                                        <div class="row g-1">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nama Sections">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text"><i class="fa-solid fa-building-columns"></i></span>
                                                    <input class="form-control" list="datalist_dept" id="exampleDataList" placeholder="Pilih Departemen...">
                                                    <datalist id="datalist_dept">
                                                        <option value="101 || Human Capital & General Affair"></option>
                                                        <option value="102 || Finance & Accounting"></option>
                                                        <option value="103 || Operations 1"></option>
                                                    </datalist>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
